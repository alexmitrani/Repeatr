...
The challenge of reaching definite conclusions about the lyrics remind me of the saying 'there's no smoke without fire' that is used in cases where there is no hard evidence but such a quantity of rumors, speculatation and anecdotal evidence that it seems unlikely that these are all baseless. This seems fitting if the song is about what I think it is about.
