...
It is possible to protest or speak out about uncomfortable issues and powerful individuals openly, but doing so can be costly and risky. Sometimes just causing offense can lead to big problems for a band, for instance the backlash experienced by The Beatles in the US to John Lennon's "more popular than Jesus" remark, which led to many incidents and the band eventually decided to not tour any more [@upi1966].
