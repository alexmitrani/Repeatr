...
|---|---|---|
| `fls_data.csv` | Raw-scraped | `Repeatr_1()`, via `scrape_fls_shows()` |
| `fls_tags.txt` | Raw-hand-curated | `Repeatr_1()`, via `fls_tags_importer()` |
| `fls_venue_geocoding.csv` / `_v2.csv` | Raw-hand-curated | `Repeatr_1()` / `nscmov()`; `_v2` also read live by `app.R` via `gsheet2tbl()` |
