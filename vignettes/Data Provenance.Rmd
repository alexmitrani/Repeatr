...
|---|---|---|
| `fls_data.csv` | Raw-scraped | `Repeatr_1()`, via `scrape_fls_shows()`. Also carries `tour`/`city`/`subdivision`/`country`, scraped from the listing pages via `scrape_fls_listing_data()` (see `?Repeatr0`) |
