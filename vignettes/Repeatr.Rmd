...
Some of the differences between the ratings are very small and the differences between the ratings of adjacent songs in the table tend to be insignificant. 
...
None of the differences between adjacent songs in the top 10 positions are significant. However, some of the differences between songs further apart on the table are significant.  
