...
The app has 12 pages spread across 3 sections:

-   flow (8 pages) - includes top-level menus for 'year' and 'tour' which will filter the contents of all the pages in this section.

    ![](images/paste-A5844D2E.png)
