...
The 'details' table can be downloaded as a CSV file using the 'Download' button.
...
The summary table can be downloaded to a CSV file using the 'Download' button.
