...
!['flow' and 'stock' sections.](images/paste-2A9DA4F4.png)

The app has 10 pages spread across 2 sections:

-   flow (7 pages) - includes top-level menus for 'year' and 'tour' which will filter the contents of all the pages in this section.

    ![](images/paste-74322788.png)

-   stock (4 pages) - includes a top-level menu for 'release' which will filter the contents of all the pages in this section.

    ![](images/paste-4B7E09FB.png)
...
![Controls for use with the timeline slider.](images/paste-5FEAF136.png)
...
![Graph on 'attendance' page when filtered by year or tour.](images/paste-EEB1441F.png)
...
The data table lists the shows that contain all of the specified songs, or none if that is the case, including the following columns:

-   fls_link provides a link to the corresponding page of the [Fugazi Live Series](https://www.dischord.com/fugazi_live_series) site

-   date - date of the show

-   hits - the number of the specified songs included in the show
