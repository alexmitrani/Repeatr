...
The [Repeatr-app](https://alexmitrani.shinyapps.io/Repeatr-app/) makes it easy to get some insights and answer questions about the Fugazi Live Series. It also provides several new ways of finding shows to listen to. The app has 10 pages which will be described in the following sections. Most of the pages have a visualisation (map or graph) and a data table further down the page, with the exception of 'transition', 'duration' and 'search' which only have data tables.

![The header and the 10 pages of the Repeatr-app.](images/paste-2408447F.png)
...
The graph shows the cumulative rendition counts for each song.

![](images/paste-E8EF7F50.png)
...
![Extract from data table on 'transition' page.](images/paste-C2994CAE.png){alt="Extract from data table on 'transition' page."}
...
![Extract from data table on 'duration' page.](images/paste-3B619926.png)
...
This page shows cumulative distributions of song durations and summary data for the renditions of each song. You can filter the contents to be displayed on the graph by release or by song, and in both cases several can be chosen.

![](images/paste-8ED969BA.png)

The data table below the graph shows summary data for renditions of the selected songs.

![](images/paste-3E43EFF1.png)
