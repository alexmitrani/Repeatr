...
transitions_by_group <- transitions3 %>%
  ...
  ungroup() %>%
  arrange(desc(count)) %>%
  mutate(proportion = count / totaltransitions)
...
The graphs above are interactive: 
