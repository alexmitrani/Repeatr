...
Guy noted that "You can’t say that it’s about a specific person or something like that. It’s more about a situation." [@mackaye1995]. However, considering the time interval in which Forensic Scene would have been written, and Guy's comment that "it was a very sad moment that produced that song ... it was kind of like that forensic analysis post-fact of the horrible thing that had just happened" [@picciotto2025], it seems likely that the lyrics to Forensic Scene were written in the first instance about the aftermath of Kurt Cobain's suicide. Fugazi were certainly aware of Nirvana and probably had met Kurt Cobain in person on a number of occasions, as well as being part of an extended scene of bands and musicians. They would have had shared interests and other things in common, and they would probably have been affected by his death.
