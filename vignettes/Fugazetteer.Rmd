...
Below the tracklist, a paragraph of notes flags anything else exceptional or noteworthy about the show or setlist - a rarely performed track, a song played out of its usual set position or twice in one show, a record-setting rendition or recording duration, a soundcheck, and other one-off curiosities - and is simply omitted when there's nothing to say.
