...
For the full column-by-column description of any dataset, see its help page (e.g. `?summary`). For fugazi.db's own tables (`shows`, `locations`, `durations`, `discography`, `songs`, `bands`), see `vignette("Data-Catalogue", package = "fugazi.db")`.
