...
For the full column-by-column description of any dataset, see its help page (e.g. `?summary`). For fugazi.db's own tables (`fls_shows`, `fls_venue_geocoding`, `fls_tags`, `releases`, `songvarslookup`, `song_tempo_bpm_data`, `songidlookup`, `played_with`, `played_with_data`), see `vignette("Data-Catalogue", package = "fugazi.db")`.
