...
For the full column-by-column description of any dataset, see its help page (e.g. `?summary`). For fugazi.db's own tables (`fls_shows`, `fls_venue_geocoding`, `fls_tags`, `releases`, `songs`, `played_with`), see `vignette("Data-Catalogue", package = "fugazi.db")`.
