...
`inst/shiny/Fugazetteer/app.R` has a reactive of the same name
(`attendancedata <- othervariables %>% ...`, app.R:2079), but it is
rebuilt fresh from `othervariables` there, not loaded from this object -
the two just happen to share a name.
