...
[Fugazetteer](articles/Fugaetteer.html) provides documentation for the [Fugazetteer](https://alexmitrani-fugazetteer.share.connect.posit.cloud/) web app.
...
[92 songs](articles/Ninety-Two-Songs.html) summarises the main results of the data processing and choice modelling as an interactive graph. The graph shows ratings, performance counts and launch dates for the 92 songs that were performed live at least twice.
