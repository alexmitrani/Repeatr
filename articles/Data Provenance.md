...
| `gid_initial_gid_sound_quality` | Derived, generated once via [`sweepstack()`](https://alexmitrani.github.io/Repeatr/reference/sweepstack.md)/[`stacks()`](https://alexmitrani.github.io/Repeatr/reference/stacks.md), not regenerated by any current script | Read directly by `app.R`’s “stock” pages |
