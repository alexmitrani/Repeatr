...
- make sure the documentation stays up to date both in Repeatr and in fugazibase
- make sure the Shiny app continues to work and produces consistent results with the initial version, unless differences are expected
- make sure that the data in fugazibase and the data in Repeatr stay consistent - changes to the data used by one package should affect the other package. 
